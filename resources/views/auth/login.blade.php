@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('Proyecto PhP')])

@section('content')
<div class="container" style="height: auto;">
  <div class="row align-items-center">
    <div class="col-md-9 ml-auto mr-auto mb-3 text-center">
      <h3>{{ __('Ingresa para ver el contenido.') }} </h3>
    </div>
    <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
      <form class="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body">
            <p class="card-description text-center">{{ __('O ingresa con ') }} <strong>admin@-email.com</strong> {{ __(' y la contraseña ') }}<strong>secreta</strong> </p>
      ...
      <div class="col-9 text-right">
            <a href="http://127.0.0.1:8000" class="text-light">
                <small>{{ __('Regresar a Inicio Laravel') }}</small>
            </a>
        </div>
    </div>
  </div>
